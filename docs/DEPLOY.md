...
# Linux amd64 → dbexplain-v0.1.7-linux-amd64-std-upx.tar.gz
# macOS arm64 → dbexplain-v0.1.7-darwin-arm64-std-noupx.tar.gz
...
bash dbexplain-skill/scripts/install.sh --offline ./dbexplain-v0.1.7-linux-amd64-std-upx.tar.gz

# 也支持直接传入原始二进制
bash dbexplain-skill/scripts/install.sh --offline ./dbexplain-linux-amd64-std

# 仅安装工具，不部署 Skill
bash dbexplain-skill/scripts/install.sh --offline ./dbexplain-v0.1.7-linux-amd64-std-upx.tar.gz --no-skill
```
