...
| 2026-06-15 | v9 | v0.1.7: Prometheus meta 表 rows 输出 + CTE 写检测加固 |
| 2026-06-12 | v8 | v0.1.6: Bug Bash 全局代码审计修复（nil panic、静默吞错、防御编码） |
| 2026-06-11 | v7 | v0.1.5: DENY_COLUMNS + SELECT * 后置列剥离
